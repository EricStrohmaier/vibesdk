                ...
                async function init() {
                        ...
                        logger.debug('Received chunk from server:', obj);
                            ...
                            logger.debug('Received template from server:', obj.template);
                                        ...
                                        if (window.location.protocol === 'https:' && result.websocketUrl.startsWith('ws://')) {
                                                result.websocketUrl = result.websocketUrl.replace('ws://', 'wss://');
                                        }
                                        ...
                                        if (window.location.protocol === 'https:' && existingWsUrl.startsWith('ws://')) {
                                                existingWsUrl = existingWsUrl.replace('ws://', 'wss://');
                                        }
