...
const worker = {
        ...
        const previewDomain = getPreviewDomain(env);
                ...
                const isReplitDevDomain = isDev(env) && (
                        hostname.endsWith('.replit.dev') || hostname.endsWith('.riker.replit.dev')
                );
                const isMainDomainRequest =
                        hostname === env.CUSTOM_DOMAIN || hostname === 'localhost' || isReplitDevDomain;
