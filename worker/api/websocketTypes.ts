...
type ScreenshotCaptureCompletedMessage = {
        type: 'screenshot_capture_completed';
        message: string;
        url: string;
};

type ScreenshotCaptureFailedMessage = {
...
export type WebSocketMessage =
    ...
    | StaticAnalysisResults
        ...
        | ScreenshotCaptureCompletedMessage
        | ScreenshotCaptureFailedMessage
